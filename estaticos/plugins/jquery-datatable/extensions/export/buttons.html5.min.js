                ...
                try {
                    ...
                    if (e) {
                        b.buttons.info(b.i18n("buttons.copyTitle",
                            "Registros Copiados"), b.i18n("buttons.copySuccess", {
                            1: "Uma linha copiada",
                            _: "<b>%d</b> Linhas foram copiadas"
                        }, a.rows), 2E3);
                        return
                    }
                } catch (h) {}
            }
            e = g("<span>" + b.i18n("buttons.copyKeys", "Pressione <i>Ctrl</i> ou <i>⌘</i> + <i>C</i> para copiar os dados da tabela<br>para a área de transferência do seu sistema.<br><br>Para cancelar, clique nesta mensagem ou pressione ESC.") + "</span>").append(d);
            b.buttons.info(b.i18n("buttons.copyTitle", "Registros Copiados"), e, 0);
            c[0].focus();
            c[0].select();
